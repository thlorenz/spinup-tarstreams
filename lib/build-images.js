 ...
 * 
 * @name spinupTarstreams::buildImages
 * @function
 * @param {Object}  images      instance of initialized `{Images}`, it is also used to emit progress events over
...
function buildImages(images, streamfns, group, useExisting, cb) {
  if (!streamfns) return si(cb.bind(null, null));
